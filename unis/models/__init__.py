...
schemaLoader.get_class("http://json-schema.org/draft-04/schema#")
schemaLoader.get_class("http://json-schema.org/draft-04/hyper-schema#")
schemaLoader.get_class("http://json-schema.org/draft-04/links#")
